...
> {
      ...
      if (pagination) {
        captionElement = (
          <OuiI18n
            ...
            default="{tableCaption}; 第 {page} 页，共 {pageCount} 页。"
            values={{
              tableCaption,
        ...
        if (pagination.totalItemCount > 0) {
          captionElement = (
            <OuiI18n
              ...
              default="此表格包含 {itemCount} 行，共 {totalItemCount} 行; 第 {page} 页，共 {pageCount} 页。"
              values={{
          ...
          captionElement = (
            <OuiI18n
              ...
              default="此表格包含 {itemCount} 行; 第 {page} 页，共 {pageCount} 页。"
              values={{
                itemCount: items.length,
                page: pagination.pageIndex + 1,
                pageCount: Math.ceil(
  ...
  renderSelectAll = (isMobile: boolean) => {
    ...
    return (
      <OuiI18n token="ouiBasicTable.selectAllRows" default="全选所有行">
  ...
  renderItemSelectionCell(itemId: ItemId<T>, item: T, selected: boolean) {
    ...
    return (
      <OuiTableRowCellCheckbox key={key}>
        <OuiI18n token="ouiBasicTable.selectThisRow" default="选择此行">
