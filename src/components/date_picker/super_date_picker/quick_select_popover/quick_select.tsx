    ...
    return (
      <fieldset>
        ...
        <OuiFlexGroup gutterSize="s" responsive={false}>
          <OuiFlexItem>
            <OuiI18n token="ouiQuickSelect.tenseLabel" default="时间时态">
              {(tenseLabel: string) => (
                <OuiSelect
                  compressed
          ...
          <OuiFlexItem>
            <OuiI18n token="ouiQuickSelect.valueLabel" default="时间值">
              {(valueLabel: string) => (
                <OuiFieldNumber
                  compressed
                  onKeyDown={this.handleKeyDown}
          ...
          <OuiFlexItem>
            <OuiI18n token="ouiQuickSelect.unitLabel" default="时间单位">
              {(unitLabel: string) => (
                <OuiSelect
                  compressed
                  onKeyDown={this.handleKeyDown}
          ...
          <OuiFlexItem grow={false}>
            <OuiButton
              ...
              <OuiI18n token="ouiQuickSelect.applyButton" default="应用" />
            </OuiButton>
          </OuiFlexItem>
        </OuiFlexGroup>
        ...
        <OuiScreenReaderOnly>
          <p id={timeSelectionId}>
            <OuiI18n
              ...
              default="当前设置为 {timeTense} {timeValue} {timeUnit}。"
              values={{
                timeTense,
                timeValue,
                timeUnit,
