...
export const OuiTourStepIndicator: FunctionComponent<OuiTourStepIndicatorProps> = ({
  ...
  if (status === 'active') {
    indicatorIcon = (
      <OuiI18n token="ouiTourStepIndicator.isActive" default="激活">
        {(isActive: string) => (
          <OuiIcon
            type="dot"
    ...
    indicatorIcon = (
      <OuiI18n token="ouiTourStepIndicator.isComplete" default="完成">
        {(isComplete: string) => (
          <OuiIcon
            type="dot"
            className="ouiStepNumber__icon"
    ...
    indicatorIcon = (
      <OuiI18n token="ouiTourStepIndicator.isIncomplete" default="未完成">
        {(isIncomplete: string) => (
          <OuiIcon
            type="dot"
            className="ouiStepNumber__icon"
