...
function ouiCardSelectableText(
  ...
  if (isSelected) {
    text = <OuiI18n token="ouiCardSelect.selected" default="已选中" />;
  } else if (isDisabled) {
    text = <OuiI18n token="ouiCardSelect.unavailable" default="不可用" />;
  } else {
    text = <OuiI18n token="ouiCardSelect.select" default="选择" />;
  }
